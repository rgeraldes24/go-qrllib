...
//   - C_TILDE_BYTES = 64 (FIPS 204 challenge hash size, differs from pre-FIPS Dilithium)
const (
	...
	// C_TILDE_BYTES is the challenge hash size (64 bytes for ML-DSA-87)
	// This differs from pre-FIPS Dilithium which uses 32 bytes
	C_TILDE_BYTES = 64
